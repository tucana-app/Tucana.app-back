...
module.exports = function confirmSignup(UUID) {
  const subject = "Confirm your email address | Ride.CR";
  const text = `Ride.CR | To access our platform, please confirm your email address following this link: ${process.env.REACT_APP_URL_CLIENT}/confirm/${UUID}`;
  const html = `
      <div>
      <h1>Ride.CR</h1>
