...
module.exports = function driverRatingStatus(isConfirmed, passenger, comment) {
  ...
  if (isConfirmed) {
    ...
    text = `Tucána | We have reviewed your rating of ${passenger.firstName}, it has been approved. Thank you for keeping the community safe`;
    html = `
        <div>
        <h1>Tucána</h1>
    ...
    text = `Tucána | We have reviewed your rating of ${passenger.firstName}, and unfortunatly it has been rejected. Reason: "${comment}".`;
    html = `
        <div>
        <h1>Tucána</h1>
