...
module.exports = function acceptedToUser(booking, formValues) {
  ...
  const text = `Tucána | 
  Su reserva para el viaje por ${booking.Ride.Driver.User.firstName} de ${booking.Ride.origin.city} a ${booking.Ride.destination.city} ha sido aceptada. Comentario del conductor: ${formValues.comment}. 
